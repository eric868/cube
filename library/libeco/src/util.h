...
public:
    ...
    static void sleep_micro(unsigned long micro_seconds);
    /*
    ...
    */
    static int64_t local_timestamp();
    /*
    * get local utc timestamp (unit:millisecond)
    */
    static int64_t local_mtimestamp();
    /*
    ...
    */
    static std::string date_string(int64_t timestamp);
    /*
    * translate timestamp into time string, format: HH:MM:SS
    */
    static std::string time_string(int64_t timestamp);
    /*
    * translate timestamp into date time string, format: YYYY-MM-DD HH:MM:SS
    */
    static std::string date_time_string(int64_t timestamp);
    /*
    * translate date time string to timestamp, format:
    *  1. YYYY-MM-DD HH:MM:SS
    *  2. YYYY/MM/DD HH:MM:SS
    */
    static int64_t string_to_timestamp(const char* str, int format = 1);
    /*
